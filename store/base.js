...
export const base = {
    ...
    mutations: {
        ...
        setBatchDetails(state, data) {
            state.batch_details = data
        },
    ...
    actions: {
        ...
        // multiple order details. However, this should replace getOrderDetails ad handle single id input
        async batchOrderDetails({commit}, data) {
                const res =  await inst.getBatchDetails(data)
